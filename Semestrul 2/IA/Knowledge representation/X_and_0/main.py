...
class Joc:
    ...
    def obtine_lista_vecini (self, linie, coloana):
        ...
        #pe coloane
        lista_vecini.append(self.matr[(linie - 1) * Joc.NR_COLOANE + coloana]) #vecin deasupra
        lista_vecini.append(self.matr[(linie + 1) * Joc.NR_COLOANE + coloana]) #vecin dedesubt
        #pe diagonale
